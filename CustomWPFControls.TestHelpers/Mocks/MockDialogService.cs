...
namespace CustomWPFControls.TestHelpers.Mocks
{
    ...
    public sealed class MockDialogService : IDialogService
    {
        ...
        /// <exception cref="MockAssertionException">Wenn kein Dialog für den Typ gefunden wurde</exception>
        ...
        /// <exception cref="MockAssertionException">Wenn keine passende Nachricht gefunden wurde</exception>
        ...
        /// </summary>
        /// <exception cref="MockAssertionException">Wenn keine Dialoge aufgerufen wurden</exception>
        public void VerifyAnyDialogShown()
        {
            if (_calls.Count == 0)
            {
                throw new MockAssertionException("Keine Dialoge aufgerufen.");
            }
        }
    ...
    /// <summary>
    /// Exception für fehlgeschlagene Assertions in Mock-Services.
    /// </summary>
