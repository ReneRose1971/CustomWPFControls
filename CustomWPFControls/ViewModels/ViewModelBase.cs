...
namespace CustomWPFControls.ViewModels
{
    ...
    /// </para>
    /// <para>
    /// <b>ServiceProvider:</b> Optional verfügbar, wenn über Constructor mit IServiceProvider erstellt.
    /// Ermöglicht Zugriff auf DI-Container für abgeleitete ViewModels.
    /// </para>
    /// </remarks>
        ...
        where TModel : class
    {
        ...
        /// Wird nur gesetzt, wenn Constructor mit IServiceProvider verwendet wird.
        /// </summary>
        ...
        /// <summary>
        /// Erstellt ein ViewModel für das gegebene Model mit Zugriff auf den ServiceProvider.
        /// </summary>
        /// <param name="model">Das zu wrappende Model.</param>
        /// <param name="serviceProvider">DI-Container für Service-Auflösung.</param>
        /// <exception cref="ArgumentNullException">Wenn <paramref name="model"/> oder <paramref name="serviceProvider"/> null ist.</exception>
