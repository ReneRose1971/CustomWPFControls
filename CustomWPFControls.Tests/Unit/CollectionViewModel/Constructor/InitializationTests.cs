...
/// <summary>
    /// Tests für die Initialisierung von CollectionViewModel mit vorausgefüllten Daten.
    /// </summary>
    /// <remarks>
    /// Diese Test-Klasse verwendet PrePopulatedCollectionViewModelFixture.
    /// 
    /// ?? WICHTIG: Alle Tests sind READ-ONLY!
    /// - Keine Daten werden hinzugefügt, entfernt oder geändert
    /// - Garantiert keine Test-Interferenzen
    /// - Sichere Parallelausführung möglich
    /// 
    /// Testet:
    /// - Laden vorhandener Models aus dem Store
    /// - ViewModel-Erstellung via Factory
    /// - Korrekte Zuordnung Model ? ViewModel
